...
$(function() {
  ...
  $('#measure-now-form').submit(function(e){
    ...
    fetch('https://api.morejoy.cc/api/auth/anonymousreg', {
      ...
      .then(result => {
        if(result.code !== 200 && result.code !== 292) {
          ...
          $('#measure-now-form').trigger('reset');
        }
      })
    return false;
  });
  $('#about .service .custom').click(function(){
    _MEIQIA('showPanel');
  });
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?8ac52f9881fe94a9d6a8815980304707";
